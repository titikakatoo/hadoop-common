...
public class MiniDFSClusterCached {

  private static final String NAMESERVICE_ID_PREFIX = "nameserviceId";
  private static final Log LOG = LogFactory.getLog(MiniDFSClusterCached.class);
  ...
  public static class Builder {
	...
	public void setNumDataNodes(int numDataNodes) {
	...
	public boolean isManageNameDfsDirs() {
		return manageNameDfsDirs;
	}

	public void setManageNameDfsDirs(boolean manageNameDfsDirs) {
		this.manageNameDfsDirs = manageNameDfsDirs;
	}

	public boolean isManageNameDfsSharedDirs() {
		return manageNameDfsSharedDirs;
	}

	public void setManageNameDfsSharedDirs(boolean manageNameDfsSharedDirs) {
		this.manageNameDfsSharedDirs = manageNameDfsSharedDirs;
	}

	public boolean isEnableManagedDfsDirsRedundancy() {
		return enableManagedDfsDirsRedundancy;
	}

	public void setEnableManagedDfsDirsRedundancy(
			boolean enableManagedDfsDirsRedundancy) {
		this.enableManagedDfsDirsRedundancy = enableManagedDfsDirsRedundancy;
	}

	public boolean isManageDataDfsDirs() {
		return manageDataDfsDirs;
	}

	public void setManageDataDfsDirs(boolean manageDataDfsDirs) {
		this.manageDataDfsDirs = manageDataDfsDirs;
	}

	public StartupOption getOption() {
		return option;
	}

	public void setOption(StartupOption option) {
		this.option = option;
	}

	public StartupOption getDnOption() {
		return dnOption;
	}

	public void setDnOption(StartupOption dnOption) {
	...
	public long[] getSimulatedCapacities() {
		return simulatedCapacities;
	}

	public void setSimulatedCapacities(long[] simulatedCapacities) {
	...
	public boolean isWaitSafeMode() {
		return waitSafeMode;
	}

	public void setWaitSafeMode(boolean waitSafeMode) {
		this.waitSafeMode = waitSafeMode;
	}

	public boolean isSetupHostsFile() {
		return setupHostsFile;
	}

	public void setSetupHostsFile(boolean setupHostsFile) {
		this.setupHostsFile = setupHostsFile;
	}

	public MiniDFSNNTopology getNnTopology() {
		return nnTopology;
	}

	public void setNnTopology(MiniDFSNNTopology nnTopology) {
		this.nnTopology = nnTopology;
	}

	public boolean isCheckExitOnShutdown() {
		return checkExitOnShutdown;
	}

	public void setCheckExitOnShutdown(boolean checkExitOnShutdown) {
		this.checkExitOnShutdown = checkExitOnShutdown;
	}

	public boolean isCheckDataNodeAddrConfig() {
		return checkDataNodeAddrConfig;
	}

	public void setCheckDataNodeAddrConfig(boolean checkDataNodeAddrConfig) {
		this.checkDataNodeAddrConfig = checkDataNodeAddrConfig;
	}

	public boolean isCheckDataNodeHostConfig() {
		return checkDataNodeHostConfig;
	}

	public void setCheckDataNodeHostConfig(boolean checkDataNodeHostConfig) {
		this.checkDataNodeHostConfig = checkDataNodeHostConfig;
	}

	public Configuration[] getDnConfOverlays() {
		return dnConfOverlays;
	}

	public void setDnConfOverlays(Configuration[] dnConfOverlays) {
     ...
     * global MiniDFSClusterCached Configuration for the corresponding DataNode.
     * 
    ...
    /**
     * Construct the actual MiniDFSClusterCached
     */
    public MiniDFSClusterCached build() throws IOException {
      return new MiniDFSClusterCached(this);
    }
  }
  
  /**
   * Used by builder to create and return an instance of MiniDFSClusterCached
   */
  protected MiniDFSClusterCached(Builder builder) throws IOException {
...
private Configuration conf;
   ...
   */
  public MiniDFSClusterCached() {
    nameNodes = new NameNodeInfo[0]; // No namenode in the cluster
    synchronized (MiniDFSClusterCached.class) {
  ...
  throws IOException {
    ...
    if (!nnTopology.allHttpPortsSpecified() &&
        nnTopology.isHA()) {
      LOG.info("MiniDFSClusterCached disabling checkpointing in the Standby node " +
    ...
    if (!nnTopology.allIpcPortsSpecified() &&
        nnTopology.isHA()) {
      LOG.info("MiniDFSClusterCached disabling log-roll triggering in the "
  ...
  /**
   * @return URI of the namenode from a single namenode MiniDFSClusterCached
   */
  public URI getURI() {
    checkSingleNameNode();
    return getURI(0);
  ...
  /**
   * @return URI of the given namenode in MiniDFSClusterCached
   */
  ...
  /**
   * @see MiniDFSClusterCached#startDataNodes(Configuration, int, boolean, StartupOption,
...
/**
   ...
   * @see MiniDFSClusterCached#finalizeCluster(Configuration)
  ...
  public synchronized DataNodeProperties stopDataNode(int i) {
    ...
    LOG.info("MiniDFSClusterCached Stopping DataNode " +
                       dn.getDisplayName() +
   ...
   */
  public static void shutdownCluster(MiniDFSClusterCached cluster) {
    if (cluster != null) {
      cluster.shutdown();
    }
  }
  ...
  public static File getBlockFile(int dnIndex, ExtendedBlock block) {
    ...
    for (int i = 0; i <=1 ; i++) {
      File storageDir = MiniDFSClusterCached.getStorageDir(dnIndex, i);
  ...
  /**
   * Throw an exception if the MiniDFSClusterCached is not started with a single
   * namenode
   */
